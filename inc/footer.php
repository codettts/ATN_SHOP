 ...
 <footer class="bg-white">
         ...
         <div class="row py-3">
             ...
             <div class="col-lg-4 col-md-6 mb-lg-0">
                 ...
                 <ul class="list-inline mt-4">
                     ...
                     <li class="list-inline-item"><a href="https://www.facebook.com/dev1502.info" target="_blank" title="facebook"><i class="fab fa-2x fa-facebook-f"></i></a></li>
     ...
     <div class="bg-light py-2">
         <div class="container text-center">
             <p class="text-muted mb-0 py-2">© ATN COMPANY .</p>
         </div>
     </div>
 </footer>
</div>
